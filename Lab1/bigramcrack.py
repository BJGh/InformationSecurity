...
print("\nДешифровка с помощью монограмм\n")

print("~~~~\tСтарт\t~~~~")

with open('texts/chapter1.txt', 'rt',encoding='utf8') as text_original: #открытие файла для чтения
...
with open('texts/caesarencrypt.txt', 'rt',encoding='utf8') as text_encrypted:

            new_text = text_encrypted.read()#poem2
